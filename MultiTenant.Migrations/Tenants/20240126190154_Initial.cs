    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_application_user_tenant", x => x.id);
                    table.ForeignKey(
                        name: "fk_application_user_tenant_tenants_tenant_id",
                        column: x => x.tenant_id,
                        principalTable: "tenants",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_application_user_tenant_users_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_application_user_tenant_tenant_id",
                table: "application_user_tenant",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "ix_application_user_tenant_user_id",
                table: "application_user_tenant",
                column: "user_id");
